...
module.exports = class Order {
  ...
  static async updateById(id, { updateProduct, updateQuantity }) {
    // TODO: Implement me
    ...
    const product = updateProduct ?? existingOrder.product;
    const quantity = updateQuantity ?? existingOrder.quantity;
    const { rows } = await pool.query(
